...
#VALORES PARA JOIN
in_data = 'C:\CartoMaestria\Ejercicio\CaracterizacionPMA\F_inter\C\SCINCE2010PobUnionDissCen.shp'
...
env.workspace = 'C:\CartoMaestria\Ejercicio\CaracterizacionPMR\SCINCE2010i'
